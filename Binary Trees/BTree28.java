    ...
    static boolean isFoldable(Node leftChild, Node rightChild){
        if (leftChild != null && rightChild != null){ 
            ...
            while(!leftQue.isEmpty() && !rightQue.isEmpty()){
                ...
                if (left.leftChild != null && right.rightChild != null){
                    leftQue.add(left.leftChild);
                    rightQue.add(right.rightChild);
                }
                else if((left.leftChild == null && right.rightChild != null) || (left.leftChild != null && right.rightChild == null) ){
                    return false;
                }
                ...
                else if((left.rightChild == null && right.leftChild != null) || (left.rightChild != null && right.leftChild == null) ){
                    return false;
                }    
            }
